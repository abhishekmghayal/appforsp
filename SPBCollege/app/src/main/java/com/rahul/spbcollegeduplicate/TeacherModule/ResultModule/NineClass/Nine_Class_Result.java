...
public class Nine_Class_Result extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        studentList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent i=new Intent(Nine_Class_Result.this, View_Result_of_nine_Activity.class);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i=new Intent(Nine_Class_Result.this, Genrate_New_Nine_Result_Activity.class);
                startActivity(i);
            }
        });
    }
