package com.rahul.spbcollegeduplicate.ClerkModule.ClerkResult.EightClassClerk;
...
import com.rahul.spbcollegeduplicate.TeacherModule.ResultModule.EightClass.View_Result_of_eight_Activity;
import com.rahul.spbcollegeduplicate.TeacherModule.ResultModule.StudentResultAadappterClass;

import java.util.ArrayList;

public class EightClassVIew extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        studentList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent i=new Intent(EightClassVIew.this, View_Result_of_eight_Activity.class);
